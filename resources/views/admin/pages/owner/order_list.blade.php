            ...
            <tr>
                ...
                <td>
                    @if(isset($order->delivery_time))
                     {{$order->delivery_time}}
                    @else
                     <input id="js-delivery_time_{{$order->id}}" class="js-delivery_time" type="text" data-order_id="{{$order->id}}" value="{{ isset($order->delivery_time) ? $order->delivery_time : null }}" name="delivery_time" class="form-control"/>
                    @endif
                </td>
